...
export function PageHeader({
  ...
  return (
    <header
      className={`sticky top-0 z-40 w-full ${bottomBorder ? "border-b border-gray-200 dark:border-slate-700/50" : ""} bg-gray-50/95 dark:bg-slate-900/95 backdrop-blur-md`}
    >
      <div
        className={`mx-auto flex ${headerHeight} items-center justify-between px-4 lg:px-6 ${maxWidthClasses[maxWidth]}`}
      >
