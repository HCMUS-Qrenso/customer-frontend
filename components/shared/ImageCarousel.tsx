 ...
 */
export function ImageCarousel({ images, alt, badges, emptyText = 'Không có hình ảnh' }: ImageCarouselProps) {
    ...
    >
      ...
      {hasImages ? (
        ...
        <div className="flex size-full flex-col items-center justify-center gap-3 text-gray-300 dark:text-slate-600">
          ...
          <span className="text-sm font-medium text-gray-400 dark:text-slate-500">{emptyText}</span>
        </div>
      )}
